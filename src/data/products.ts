...
export const PRODUCTS: Product[] = [
  ...
  { id: 'p1', name: 'Organizador de escritorio modular', cat: 'Hogar', price: 29700, g: 225, mat: 'Colores a elección', desc: 'Ordená lápices, cargadores y clips en un solo módulo apilable. Se ensambla sin herramientas y se adapta al espacio que tengas en el escritorio.', mpLink: null, status: 'listo' }, // [estimado +25%]
  ...
  { id: 'p2', name: 'Soporte de celular ajustable', cat: 'Gadgets', price: 15800, g: 121, mat: 'Negro o blanco', desc: 'Se pliega para viajar y se abre en el ángulo que necesites para mirar, tipear o hacer videollamadas. Base antideslizante, sin mecanismos que se rompan.', mpLink: null, status: 'extruyendo' },
  { id: 'p4', name: 'Portarretrato personalizado', cat: 'Regalos', price: 7900, g: 60, mat: 'Con el texto que quieras', desc: 'Un marco simple con el texto que quieras grabado — nombre, fecha, una frase. Para esa foto que ya sacaste pero nunca imprimiste.', mpLink: null, status: 'extruyendo' },
  { id: 'p6', name: 'Rompecabezas de píxeles personalizado', cat: 'Juguetes', price: 9200, g: 70, mat: 'Colores a elección', desc: 'Elegís la imagen, la convertimos en piezas para armar. Entretiene más de una tarde y queda de recuerdo.', mpLink: null, status: 'listo' },
  { id: 'p7', name: 'Gancho organizador de cables x6', cat: 'Hogar', price: 5000, g: 38, mat: 'Flexible', desc: 'Seis clips flexibles para que los cables del escritorio dejen de ser un nudo. Se pegan o atornillan, como prefieras.', mpLink: null, status: 'listo' }, // [estimado +25%]
  { id: 'p8', name: 'Llavero personalizado con nombre', cat: 'Regalos', price: 3500, g: 12, mat: 'Color a elección', desc: 'Tu nombre o el de quien se lo vas a regalar, en la tipografía que elijas. Diez minutos de trabajo, un regalo que no se olvida.', mpLink: null, status: 'extruyendo' }, // [estimado +25%] · piso
  { id: 'p9', name: 'Portamate con manija', cat: 'Hogar', price: 19800, g: 150, mat: 'Resistente al uso diario', desc: 'Para llevar el mate a todos lados sin quemarte ni derramarlo — la manija hace toda la diferencia. Resiste el uso diario.', mpLink: null, status: 'listo' }, // [estimado +25%]
  { id: 'p10', name: 'Jarrón decorativo personalizado', cat: 'Deco', price: 17200, g: 130, mat: 'En el tamaño que necesites', desc: 'Una pieza escultórica para la mesa o la estantería, en el tamaño que necesites. Cada una sale un poco distinta — es parte de la gracia.', mpLink: null, status: 'pedido' },
  { id: 'p11', name: 'Fidget articulado (pulpo/dragón)', cat: 'Juguetes', price: 13200, g: 100, mat: 'Articulado, en una sola pieza', desc: 'Se mueve articulación por articulación, como el animal real. En una sola pieza, sin armado ni piezas sueltas que perder.', mpLink: null, status: 'listo' }, // [estimado +25%]
  { id: 'p12', name: 'Cartel / logo para emprendimientos', cat: 'Regalos', price: 13200, g: 100, mat: 'A medida', desc: 'Tu logo o el nombre de tu local, en 3D, listo para colgar o apoyar en el mostrador. Buen regalo para quien recién arranca un negocio.', mpLink: null, status: 'pedido' },
];
