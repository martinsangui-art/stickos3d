...
export const PRODUCTS: Product[] = [
  ...
  { id: 'p21', name: 'HUSO', cat: 'Deco', price: 49999, g: 345, mat: 'Dos colores a elección', desc: 'Pantalla torcida sobre sí misma, con una trama fina que deja pasar la luz sin mostrar la bombita. 29 cm de alto. Luz baja y cálida para una mesa, un estante o el piso al lado del sillón. Llega lista para enchufar, con cable y foco LED cálido. Elegís la combinación de colores de pantalla y base. Precio de lanzamiento por las primeras unidades.', mpLink: null, status: 'pedido', imgs: ['/assets/products/huso-1.jpg', '/assets/products/huso-2.jpg', '/assets/products/huso-3.jpg'] },
